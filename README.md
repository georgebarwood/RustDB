...
See https://crates.io/crates/rustweb2 for example program : a webserver based on rustdb database, with database browsing, password hashing, database replication, email transmission and timed jobs.
